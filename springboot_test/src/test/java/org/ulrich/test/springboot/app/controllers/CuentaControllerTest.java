package org.ulrich.test.springboot.app.controllers;
...
import org.ulrich.test.springboot.app.models.TransaccionDto;
...
class CuentaControllerTest {
    ...
    void testListar() throws Exception {
        //Given
        List<Cuenta> cuentas = Arrays.asList(crearCuenta001().orElseThrow(), crearCuenta0002().orElseThrow());
